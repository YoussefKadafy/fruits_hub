...
class AppColors {
  ...
  static const Color grayScale50 = Color(0xffF8F9FA);
  static const Color backgroundGray = Color(0xffF1F5F9);
  static const Color disabledColor = Color(0xffE0E6EC);
  static const Color textFieldFillColor = Color(0xffE6E9EA);
  static const Color white = Colors.white;
  static const Color black = Colors.black;
  static const Color lightGray = Color(0xffF3F5F7);
  static const Color lightGrayWith50Opacity = Color(0x80F2F3F3);
  static const Color grayScale950 = Color(0xff0C0D0D);  static const Color grayScale500 = Color(0xff4E5556);


  /// TEXTS COLORS
  /// ----------------
  static const Color onboardingDescriptionTextColor = Color(0xff4E5556);
  static const Color disableTextColor = Color(0xff999DA0);
}
